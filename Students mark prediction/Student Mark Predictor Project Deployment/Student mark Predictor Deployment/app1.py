...
app = Flask(__name__)
model = joblib.load(r"C:\Users\Subasish Sahoo\Desktop\kodi sir\JAN\3 JAN\Students mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
